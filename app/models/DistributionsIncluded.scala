...
object DistributionsIncluded extends Enumerable.Implicits {
  ...
  case object Yes extends WithName("yes") with DistributionsIncluded
  case object No extends WithName("no") with DistributionsIncluded

  val values: Seq[DistributionsIncluded] = Seq(
    Yes,
    No
  )
